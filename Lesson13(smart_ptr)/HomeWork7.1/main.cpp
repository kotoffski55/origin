...
public:
    ...
    {
        //std::unique_ptr<tridiagonal_matrix> ptr(new tridiagonal_matrix(m_down,m_middle,m_middle));
        auto ptr = std::make_unique<tridiagonal_matrix>(tridiagonal_matrix(m_down, m_middle, m_middle));  
        return *ptr;
    }
};
